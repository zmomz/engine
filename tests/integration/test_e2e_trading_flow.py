...
@pytest.fixture
def auth_headers(e2e_user: User):
    """Get authentication headers for E2E user."""
    token, _, _ = create_access_token(data={"sub": e2e_user.username})
...
class TestWebhookToPositionFlow:
    ...
    @pytest.mark.asyncio
    async def test_new_position_creation_flow(
        self,
    ...
    @pytest.mark.asyncio
    async def test_pyramid_continuation_flow(
        self,
        db_session: AsyncSession,
        e2e_user: User
    ):
...
class TestDCAOrderLifecycle:
    ...
    @pytest.mark.asyncio
    async def test_dca_order_creation_and_fill(
        self,
        db_session: AsyncSession,
        e2e_user: User
    ):
    ...
    @pytest.mark.asyncio
    async def test_take_profit_order_execution(
        self,
        db_session: AsyncSession,
        e2e_user: User
    ):
...
class TestQueueManagementE2E:
    ...
    @pytest.mark.asyncio
    async def test_signal_queuing_when_pool_full(
        self,
        db_session: AsyncSession,
        e2e_user: User
    ):
    ...
    @pytest.mark.asyncio
    async def test_signal_promotion_after_slot_available(
        self,
        db_session: AsyncSession,
        e2e_user: User
    ):
    ...
    @pytest.mark.asyncio
    async def test_queued_signals_cancelled_on_exit(
        self,
        db_session: AsyncSession,
        e2e_user: User
    ):
...
class TestPositionStateTransitions:
    ...
    @pytest.mark.asyncio
    async def test_live_to_partially_filled_transition(
        self,
        db_session: AsyncSession,
        e2e_user: User
    ):
    ...
    @pytest.mark.asyncio
    async def test_partially_filled_to_active_transition(
        self,
        db_session: AsyncSession,
        e2e_user: User
    ):
    ...
    @pytest.mark.asyncio
    async def test_active_to_closing_transition(
        self,
        db_session: AsyncSession,
        e2e_user: User
    ):
...
class TestMultiPositionCoordination:
    ...
    @pytest.mark.asyncio
    async def test_multiple_symbols_independent_management(
        self,
        db_session: AsyncSession,
        e2e_user: User
    ):
    ...
    @pytest.mark.asyncio
    async def test_same_symbol_different_timeframes(
        self,
        db_session: AsyncSession,
        e2e_user: User
    ):

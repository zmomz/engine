...
Revision ID: fd17aff21f62
Revises: 
Create Date: 2025-12-11 13:02:16.495919
...
def upgrade() -> None:
    ...
    sa.Column('exchange', sa.String(), nullable=False),
    sa.Column('entry_order_type', sa.Enum('limit', 'market', name='entry_order_type_enum'), nullable=False),
    sa.Column('dca_levels', sa.JSON(), nullable=False),
    sa.Column('pyramid_specific_levels', sa.JSON(), nullable=False),
    sa.Column('tp_mode', sa.Enum('per_leg', 'aggregate', 'hybrid', name='take_profit_mode_enum'), nullable=False),
    sa.Column('tp_settings', sa.JSON(), nullable=False),
    sa.Column('max_pyramids', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    ...
    sa.Column('status', sa.Enum('pending', 'trigger_pending', 'open', 'partially_filled', 'filled', 'cancelled', 'failed', name='order_status_enum'), nullable=False),

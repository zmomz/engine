...
Revision ID: 969457dda485
Revises: 
Create Date: 2025-11-13 15:29:58.496147
...
def upgrade() -> None:
    ...
    sa.Column('loser_group_id', types.GUID(), nullable=True),
    ...
    sa.Column('id', types.GUID(), nullable=False),
    sa.Column('group_id', types.GUID(), nullable=False),
    sa.Column('pyramid_id', types.GUID(), nullable=False),

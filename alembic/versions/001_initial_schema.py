...
def upgrade() -> None:
    ...
    op.create_table('dca_configurations',
        ...
        sa.Column('entry_order_type', entry_order_type_enum, nullable=False),
        sa.Column('dca_levels', sa.JSON(), nullable=False),
        sa.Column('pyramid_specific_levels', sa.JSON(), nullable=False),
        sa.Column('tp_mode', take_profit_mode_enum, nullable=False),
    ...
    op.create_table('position_groups',
        ...
        sa.Column('status', group_status_enum, nullable=False),
        ...
        sa.Column('tp_mode', tp_mode_enum, nullable=False),
    ...
    op.create_table('pyramids',
        ...
        sa.Column('status', pyramid_status_enum, nullable=False),
